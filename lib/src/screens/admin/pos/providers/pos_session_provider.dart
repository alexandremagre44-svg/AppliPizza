...
final cashierSessionServiceProvider = Provider<CashierSessionService>((ref) {
...
final activeCashierSessionProvider = StreamProvider<CashierSession?>((ref) {
...
final sessionReportProvider = Provider.family<SessionReport?, String>((ref, sessionId) {
  final service = ref.watch(cashierSessionServiceProvider);
