// lib/src/staff_tablet/providers/staff_tablet_cart_provider.dart
...
// =============================================
// STAFF TABLET CART STATE NOTIFIER
// =============================================

/// Provider for staff tablet cart - separate from client cart
final staffTabletCartProvider = StateNotifierProvider<StaffTabletCartNotifier, CartState>((ref) {
  return StaffTabletCartNotifier();
});

class StaffTabletCartNotifier extends StateNotifier<CartState> {
  StaffTabletCartNotifier() : super(CartState([]));
